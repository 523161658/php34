...
return array(
	...
	'validate' => "
		...
		array('module_name', '1,10', '模块名称的值最长不能超过 10 个字符！', 2, 'length', 3),
		array('controller_name', '1,10', '控制器名称的值最长不能超过 10 个字符！', 2, 'length', 3),
		array('action_name', '1,10', '方法名称的值最长不能超过 10 个字符！', 2, 'length', 3),
