...
class <?php echo $tpName; ?>Controller extends PlateformController 
{
    public function add()
    {
    	if(IS_POST)
...
<?php endif; ?>
		...
		$this->setPageInfo('添加<?php echo $config['tableCnName']; ?>', '<?php echo $config['tableCnName']; ?>列表', U('lst?p='.I('get.p')));
		$this->display();
    }
...
<?php endif; ?>
		...
		$this->setPageInfo('修改<?php echo $config['tableCnName']; ?>', '<?php echo $config['tableCnName']; ?>列表', U('lst?p='.I('get.p')));
		$this->display();
    }
...
<?php endif; ?>
		...
		$this->setPageInfo('<?php echo $config['tableCnName']; ?>列表', '添加<?php echo $config['tableCnName']; ?>', U('add'));
    	$this->display();
    }
}